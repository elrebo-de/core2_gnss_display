...
void lv_gnss_display(void)
{
    ...
    lv_obj_set_pos(scale, 320 - 150 - 10, 10);
    ...
    lv_obj_set_pos(label, 320 - 150/2 - 10 - 100/2, 150/2 + 10 - 20);
    ...
    lv_obj_set_pos(tacho, 10, 240-48-10);
    ...
    // x: 0 + Rand
    // y: 30 + Rand
    lv_obj_set_pos(anzahlSatelliten, 10, 135);
